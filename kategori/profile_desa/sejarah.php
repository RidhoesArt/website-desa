...
<section class="sejarah-desa-section">
	...
	<div class="container sejarah-desa bg-white mb-3">
		<h5 class="mt-5 mx-5" style=color:black;>Sejarah Desa Keude Krueng Geukuh</h5>

				<div class="mx-5"><p>&nbsp;&nbsp;&nbsp;Gampong Keude Krueng Geukuh didirikan oleh Ampoen Budjang pada tahun 1952.
			Gampong yang berada di Kecamatan Dewantara Kabupaten Aceh Utara secara
			geografis terletak di 97 05'  00" BT dan 05 14' 00" LU.
			Adapun batas-batas wilayah :</p>
			<div class="sc_dropcaps sc_dropcaps_style_3">
				<table>
					<tr>
						<td>
							a. Sebelah Utara	: Laut Selat Malaka
						</td>
						<td>
					...
					<tr>
						<td>
							b. Sebelah Timur	: Gampong Tambon Baroh
						</td>
					</tr>
					<tr>
						<td>
							c. Sebelah Selatan	: Gampong Uteun Galinggang dan Tambon Baroh
						</td>
					</tr>
					<tr>
						<td>
							d. Sebelah Barat	: Gampong Uteun Gelinggang dan Bangka Jaya
						</td>
					</tr>
				</table>
			</div>
			<br>
			<div class="sc_dropcaps sc_dropcaps_style_3"><p>&nbsp;&nbsp;&nbsp;Adapun luas wilayah Gampong Keude Krueng Geukuh adalah 199 Ha yang terbagi
			atas 5 dusun (Bujang Salim, Batee Timoh, Para Tujoh, Beringin Dua dan Cot Trieng).
			Jumlah penduduk per Desember 2021 adalah 4.425 jiwa yang terbagi atas 1.302 KK
			dalam 5 dusun. Mata pencaharian penduduk kampung di dominasi oleh pedagang,
			buruh bangunan dan selebihnya memiliki mata pencaharian sebagai berikut :</p></div>
			<table>
				<tr>
					<td>
						a. Pedagang				: 50%
				...
				<tr>
					<td>
						b. Buruh dan Tukang		: 30%
					</td>
				</tr>
				<tr>
					<td>
						c. Karyawan dan Pegawai	: 10%
					</td>
				</tr>
				<tr>
					<td>
			...
			<br>
			Berikut Table pemerintahan Gampong Keude Krueng Geukuh :</div>
		<table class="table table-striped mt-3">
			...
			$sql2 = mysqli_query($con, "SELECT * FROM tbl_sejarahpemimpin");
			?>
			<?php $i = 1; ?>
